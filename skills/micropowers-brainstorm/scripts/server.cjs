...
const MICROPOWERS_VERSION = readMicropowersVersion();
...
function readMicropowersVersion() {
...
function brandMarkup() {
  const version = escapeHtmlText(MICROPOWERS_VERSION);
  return '<div class="brand"><span class="brand-copy">Micropowers v' + version + '</span></div>';
}
